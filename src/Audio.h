...
#include "../lib/FMOD Programmers API/api/inc/fmod.hpp"
#include "../lib/FMOD Programmers API/api/inc/fmod_errors.h"
#include "../lib/FMOD Programmers API/examples/common/wincompat.h"
...
class Audio {
   private:
      /*void initSoundVariables();
      void checkGlobalSettings();

      void enumeratePlaybackDrivers();
      void findPlaybackDrivers(int *numDrivers);
      void displayPlaybackDriverChoices(int numDrivers);
      int getPlaybackDriverChoice(int numDrivers);
      void setPlaybackDriver(int driver);

      void enumerateRecordDrivers();
      void findRecordDrivers(int *numDrivers);
      void displayRecordingDriverChoices(int numDrivers);
      void getRecordingDriverChoice(int numDrivers);
      void setRecordFormat();

      void createASoundToRecordTo();
      void startTheInterface();
      void mainLoop();
      void shutDown();

      void detectPitchWithFMOD();
